...
// import { getDeviceInfo } from "@/lib/utils/dataFormateUtils";

// _ -> userAgent
function twoFAVerification(
  otp: string,
  validInMin: string | number,
  email: string,
  _: string,
) {
  // const ua: { [key: string]: string | undefined } = getDeviceInfo(userAgent);
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td
                      ...
                      "
                    >
                      RayAuth Two step Verification(2FA) Code
                    </td>
                    <td width="32px"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>
                      <span class="im"
                        ...
                        <p>
                          We received a request to access your RayAuth Account
                          <span style="color: #659cef" dir="ltr"
                            ><a href="mailto:${email}" target="_blank"
                              >${email}</a
                            ></span
                          >
                          through your email address. Your RayAuth 2FA code is:
                        </p></span
                      >
                        ...
                        <p dir="ltr">
                          <span
                            style="
                              ...
                              font-weight: bold;
                            "
                            >Valid for ${validInMin} Min</span
                          >
                        </p>
                      </div>
                  <!--    <ul>
                     {Object.keys(ua)
                        .map(k => "<li>{k}: {ua[k] || "NONE"}</li>")
                        .join("")}
                      </ul> --!>
                      <span><p>
                          If you did not request this code, it is possible that
                          someone else is trying to access the RayAuth Account
                          <span style="color: #659cef" dir="ltr"
                            ><a href="mailto:${email}" target="_blank"
                              >${email}</a
                            ></span
                          >.
                          <strong
                            >Do not forward or give this code to anyone.</strong
                          >
                        </p>
                        <p>Sincerely yours,</p>
