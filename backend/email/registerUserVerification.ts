...
function registerUserVerificationTemplate(otp: string, validInMin: string | number, email: string) {
...
export default registerUserVerificationTemplate;
